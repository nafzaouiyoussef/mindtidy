  ...
  return (
    <section id="final-cta" className="scroll-mt-24 px-5 pb-24 pt-4 sm:px-8">
      <div className="mx-auto max-w-4xl">
        <Reveal className="relative overflow-hidden rounded-4xl bg-teal px-8 py-14 text-center shadow-lift sm:px-14 sm:py-20">
          {/* decorative circles */}
          ...
          <h2 className="relative font-heading text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Today could feel <em className="text-sand">manageable</em>.
          </h2>
          <p className="relative mx-auto mt-4 max-w-xl text-lg leading-relaxed text-mint">
            Not perfect. Not optimized. Just… manageable. Download the bundle,
            dump your brain onto the page, and pick your three things for
            tomorrow.
          </p>

          <div className="relative mt-9">
            <BuyButton className="!bg-white !text-teal hover:!bg-cream">
          ...
          <div className="relative mx-auto mt-9 flex max-w-md items-center gap-4 rounded-2xl bg-white/10 p-4 text-left backdrop-blur-sm">
            ...
            <p className="text-sm leading-relaxed text-white">
              <strong className="font-semibold">14-day “it has to fit” guarantee.</strong>{" "}
